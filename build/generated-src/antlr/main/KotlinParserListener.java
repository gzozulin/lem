...
public interface KotlinParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link KotlinParser#commentSection}.
	 * @param ctx the parse tree
	 */
	void enterCommentSection(KotlinParser.CommentSectionContext ctx);
	/**
	 * Exit a parse tree produced by {@link KotlinParser#commentSection}.
	 * @param ctx the parse tree
	 */
	void exitCommentSection(KotlinParser.CommentSectionContext ctx);
	/**
