...
declaration
    : commentSection? classDeclaration
    | commentSection? objectDeclaration
    | commentSection? functionDeclaration
    | commentSection? propertyDeclaration
    | commentSection? typeAlias
    ;
